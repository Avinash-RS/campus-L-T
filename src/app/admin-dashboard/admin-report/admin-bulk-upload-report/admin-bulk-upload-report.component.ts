...
@Component({
  selector: 'app-admin-bulk-upload-report',
  templateUrl: './admin-bulk-upload-report.component.html',
  styleUrls: ['./admin-bulk-upload-report.component.scss']
})
export class AdminBulkUploadReportComponent implements OnInit, AfterViewInit {
