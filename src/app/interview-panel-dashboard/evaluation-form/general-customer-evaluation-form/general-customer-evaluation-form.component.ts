...
@Component({
  selector: 'app-general-customer-evaluation-form',
  templateUrl: './general-customer-evaluation-form.component.html',
  styleUrls: ['./general-customer-evaluation-form.component.scss'],
  providers: [
    // {
...
export class GeneralCustomerEvaluationFormComponent implements OnInit {
@ViewChild('hrComments', {static: false}) hrComments: TemplateRef<any>;
@Input() candidateId;
...
@Input() shortlist_name;
  ...
  adaform_recommend = 'next_round_recommend_status';
  adaform_recommend_comments = 'reason_for_recommend';
  adaform_reassign_history_Status = 'reassigned_panel_status';
  adaform_reassign_history = 'reason_for_reassign';
  evaluationApiResult: any;
    ...
    this.adminService.getAdaniEvaluationDetails(apiData).subscribe((success: any) => {
      ...
      if (data) {
        this.evaluationForm.patchValue({
          ...
          [this.adaform_recommend]: data && data[this.adaform_recommend].toString() ? data[this.adaform_recommend].toString() : null,
          [this.adaform_recommend_comments]: data && data[this.adaform_recommend_comments] ? data[this.adaform_recommend_comments] : null,
  ...
  nginitFunc() {
    ...
    this.evaluationForm = this.formBuilder.group({
      ...
      [this.adaform_recommend_comments]: new FormControl('', [RemoveWhitespace.whitespace(), Validators.maxLength(255), myGlobals.alphaNum]),
      [this.adaform_recommend]: new FormControl(null, [Validators.required]),
  ...
  get recommend_comments() {
    return this.evaluationForm.get(this.adaform_recommend_comments);
  }
  get recommend() {
    return this.evaluationForm.get(this.adaform_recommend);
  }
  // get valuesIntegrity() {
  ...
  history() {
    this.matDialog.open(this.hrComments, {
      width: '803px',
      panelClass: 'viewCandidateHistory',
    });
  }
