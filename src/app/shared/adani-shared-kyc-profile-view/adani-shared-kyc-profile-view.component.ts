...
@Component({
  selector: 'app-adani-shared-kyc-profile-view',
  templateUrl: './adani-shared-kyc-profile-view.component.html',
  styleUrls: ['./adani-shared-kyc-profile-view.component.scss'],
  providers: [
...
export class AdaniSharedKycProfileViewComponent implements OnInit, AfterViewInit, OnDestroy  {
  ...
  formSubmit(routeValue?: any) {
   ...
   this.newSaveProfileDataSubscription = this.candidateService.newSaveProfileData(ProfileSubmitApiRequestDetails).subscribe((data: any) => {
    ...
    return this.appConfig.routeNavigation(routeValue ? routeValue : CONSTANT.ENDPOINTS.CANDIDATE_DASHBOARD.ADANI_JOINING_SUBMIT);
    });
  }
