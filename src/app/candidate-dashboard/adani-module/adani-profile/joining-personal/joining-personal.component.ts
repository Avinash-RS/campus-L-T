...
@Component({
  selector: 'app-adani-joining-personal',
...
export class AdaniJoiningPersonalComponent implements OnInit, AfterViewInit, OnDestroy {
...
// Form control name declaration end
  ...
  formInitialize() {
    this.personalForm = this.fb.group({
      ...
      [this.form_offer_reference]: [null, [RemoveWhitespace.whitespace(), this.glovbal_validators.offer()]],
