...
@Component({
  selector: 'app-ssc-upload-section',
  templateUrl: './ssc-upload-section.component.html',
  styleUrls: ['./ssc-upload-section.component.scss']
})
export class SscUploadSectionComponent implements OnInit {
