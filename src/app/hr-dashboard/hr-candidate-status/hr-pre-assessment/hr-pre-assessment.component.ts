...
@Component({
  selector: 'app-hr-pre-assessment',
  templateUrl: './hr-pre-assessment.component.html',
  styleUrls: ['./hr-pre-assessment.component.scss'],
  providers: [
...
export class HrPreAssessmentComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: any[] = ['uid', 'new_candidate_id', 'mail_sent', 'registered', 'profile_submit', 'profile_shortlist', 'assement', 'tag_name', 'institute', 'foldername', 'shortlistname', 'date_time'];
