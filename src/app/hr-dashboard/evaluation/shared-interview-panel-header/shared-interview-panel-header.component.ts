...
@Component({
  selector: 'app-shared-interview-panel-header',
  templateUrl: './shared-interview-panel-header.component.html',
  styleUrls: ['./shared-interview-panel-header.component.scss']
})
export class SharedInterviewPanelHeaderComponent implements OnInit {
