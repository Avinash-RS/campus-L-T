...
import { DateAdapter, MAT_DATE_LOCALE, MAT_DATE_FORMATS, MatTableDataSource, MatDialog } from '@angular/material';
...
@Component({
  selector: 'app-adani-interview-results',
  templateUrl: './adani-interview-results.component.html',
  styleUrls: ['./adani-interview-results.component.scss'],
  providers: [
  // {
...
export class AdaniInterviewResultsComponent implements OnInit {
  @Input() candidateId;
