...
import { AgProgressBarComponent } from './evaluation/new-interviewpanel-assigned-details/assigned-details/ag-progress-bar/ag-progress-bar.component';
import { AdaniInterviewResultsComponent } from './evaluation/new-interviewpanel-assigned-details/hr-evaluation-main-screen/hr-sub-interview-results/adani-interview-results/adani-interview-results.component';
import { GeneralInterviewResultsComponent } from './evaluation/new-interviewpanel-assigned-details/hr-evaluation-main-screen/hr-sub-interview-results/general-interview-results/general-interview-results.component';
ModuleRegistry.registerModules(AllModules);

@NgModule({
  declarations: [HrMasterComponent, HrShortlistingComponent, FirstLevelShortlistComponent, HrMainDashboardComponent, HrUserManagementComponent, ShortlistedCandidateListComponent, HrReportsComponent, ReportsListComponent, FirstLevelShorlistReportsComponent, EvaluationComponent, UserListComponent, HrCandidateStatusComponent, HrPreAssessmentComponent, HrRecruitmentComponent, SecondLevelShortlistComponent, SecondLevelAssessmentListComponent, SecondLevelCandidateListofAssessComponent, SharedSubHeaderSecondLevelShortlistComponent, SecondLevelShortlistedCandidatesReportComponent, HrEvaluationMainScreenComponent, HrSubAssessmentsComponent, HrSubEducationComponent, HrSubEmploymentComponent, SubSharedEvaluationHeaderComponent, NewInterviewpanelAssignmentScreenComponent, NewInterviewpanelAssignedDetailsComponent, NewInterviewpanelResultsUploadComponent, IcAddorListComponent, OfferedCandidatesListComponent, AddICComponent, ListofICComponent, UploadSelectedCandidatesComponent, ListofSelectedCandidatesComponent, UploadSelectedCandidatesErrorReportComponent, BusinesspanelRouteComponent, SscUploadSectionComponent, BulkUploadsComponent, ClickableStatusBarComponent, ScheduleInterviewPopupComponent, AssignedDetailsComponent, ScheduleVideoAssessComponent, EvaluatorAssignForVideoAssessComponent, RouteEvaluatorAssignForVideoAssessComponent, HrSubInterviewResultsComponent, DashboardOverviewComponent, MiscellaneousMasterComponent, MiscCollegesComponent, MiscCandidateNameChangeComponent, EmailTriggerMasterComponent, EmailTriggerFunctionComponent, EmailJobsMasterComponent, EmailJobsComponent, SelectedCandidateComponent, ChooseTemplateComponent, BatchwiseEmailJobsComponent, EmailTriggerPreviewComponent, EmailTriggerConfirmationComponent, AgProgressBarComponent, AdaniInterviewResultsComponent, GeneralInterviewResultsComponent],
  ...
  imports: [
    ...
    AgGridModule.withComponents([ClickableStatusBarComponent, AgProgressBarComponent]),
    OwlDateTimeModule,
